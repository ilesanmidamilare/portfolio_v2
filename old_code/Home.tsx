...
<header className='flex h-6 jjustify-center  bg-red-400'>
        <Link href={'/'} passHref>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full m-auto max-w-[400px] aspect-square p-4 lg:hidden bg-brand-dark-gray">
        
      </div>


      {/* Socials */}
      {/* <div className="flex justify-center flex-shrink-0 items-center gap-12">
